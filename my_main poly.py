...
if __name__ == '__main__':
    ...
    # X.to_csv('analyzed_data_x.csv', index=False)
    # y.to_csv('analyzed_data_y.csv', index=False)
    ...
    israel_data = df[df['Country'] == 'Israel']
    X = israel_data['DayOfYear'].values.reshape(-1, 1)
    y = israel_data['Temp'].values.reshape(-1, 1)
