...
def test_preprocess_irrelevant_cols_deleted():
    irrelevant_cols = {'id','zipcode','lat', 'date'}  # Change according to your implementation
    # Arrange
...
def test_preprocess_when_bad_values_in_irrelevant_columns_should_keep_row():
    # Arrange
    X, y = create_dummy_house_dataframe(
        [[0, "20141013T000000", 10000, 3, 1, 1180, 5650, "1", 0, 0, 3, 7, 1180, 0, 1955, 0, "98178", 47.5112, 122.257, 1340, 5650]])
...
def test_preprocess_bad_rows_tiny_rooms():
    ...
    minimum_size_in_sqft = 20  # Change according to your implementation
    X, y = create_dummy_house_dataframe(
